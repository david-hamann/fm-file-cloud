...
- **User**: Individual account belonging to a tenant. Has email, hashed password, role within tenant, creation/modification timestamps, status (active/suspended/removed). Tenant users MUST be a member of at least one group.
